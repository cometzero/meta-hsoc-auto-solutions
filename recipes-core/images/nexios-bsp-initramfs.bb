...
PACKAGE_INSTALL:append:apollo-qvp = " libgpiod-tools i2c-tools devmem2 kernel-module-spi-loopback-test kernel-module-dmatest alsa-utils-aplay i2s-loopback"
